...
class MessagesPlugin(Plugin):
    ...
    def print_message(self, date, peer_id, text):
        user = self.vk_cli.get_user_profile(peer_id) if peer_id != 0 else {'last_name': '', 'first_name': 'Me'}
    ...
    def initialize_commands_decorators(self):
        ...
        def read_cmd(args):
            ...
            self.vk_cli.load_profiles( {message['from_id']: 0 for message in self.messages}.keys() )
